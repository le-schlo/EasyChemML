...
class RootMeanSquaredError(Abstract_Metric):
    ...
    def calc(self, y_true, y_pred, y_predict_proba):
        return mean_squared_error(y_true, y_pred, squared=False, **self._settings)
    ...
    def __eq__(self, other):
        if isinstance(other, RootMeanSquaredError):
